  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <div className="flex items-center gap-3 mb-6">
        <Link href="/" className="text-sm text-gray-400 hover:text-gray-600">竊・繝帙・繝</Link>
      ...
      {members.length === 0 && (
        <p className="text-sm text-orange-500 mb-4">
          蜈医↓ <Link href="/members" className="underline">繝｡繝ｳ繝舌・邂｡逅・/Link> 縺ｧ繝｡繝ｳ繝舌・繧定ｿｽ蜉縺励※縺上□縺輔＞
        </p>
      )}

      {/* 逶ｮ讓吩ｸ隕ｧ */}
      {Object.keys(grouped).length === 0 ? (
        <p className="text-sm text-gray-400">縺薙・譛滄俣縺ｮ逶ｮ讓吶・縺ｾ縺縺ゅｊ縺ｾ縺帙ｓ</p>
      ) : (
